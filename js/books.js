...
class BooksManager {
    constructor() {
        ...
        window.booksManager = this; // Make globally accessible
        this.init();
    }
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm btn-primary" id="addBookBtn">
                                <i class="fas fa-plus"></i> Add Book
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-secondary" id="exportBooksBtn">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm">
                        <button class="btn btn-outline-primary action-btn" data-action="view" data-id="${book.id}" title="View Details">
                            <i class="fas fa-eye pointer-events-none"></i>
                        </button>
                        <button class="btn btn-outline-success action-btn" data-action="mark-read" data-id="${book.id}" title="Mark as Read">
                            <i class="fas fa-check pointer-events-none"></i>
                        </button>
                        <button class="btn btn-outline-info action-btn" data-action="loan" data-id="${book.id}" title="Create Loan">
                            <i class="fas fa-hand-holding pointer-events-none"></i>
                        </button>
                        <button class="btn btn-outline-secondary action-btn" data-action="edit" data-id="${book.id}" title="Edit">
                            <i class="fas fa-edit pointer-events-none"></i>
                        </button>
                        <button class="btn btn-outline-success action-btn" data-action="duplicate" data-id="${book.id}" title="Duplicate">
                            <i class="fas fa-copy pointer-events-none"></i>
                        </button>
                        <button class="btn btn-outline-danger action-btn" data-action="delete" data-id="${book.id}" title="Delete">
