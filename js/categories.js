...
class CategoriesManager {
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary" id="exportCategoriesBtn">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center" style="background-color: ${category.color}20; border-left: 4px solid ${category.color};">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item action-btn" href="#" data-action="edit" data-id="${category.id}">
                                    <i class="fas fa-edit me-2 pointer-events-none"></i>Edit
                                </a></li>
                                <li><a class="dropdown-item action-btn" href="#" data-action="delete" data-id="${category.id}">
                                    <i class="fas fa-trash me-2 pointer-events-none"></i>Delete
                                </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-outline-primary action-btn" data-action="view" data-id="${category.id}" title="View Details">
                                    <i class="fas fa-eye pointer-events-none"></i>
                                </button>
                                <button class="btn btn-sm btn-outline-info action-btn" data-action="view-books" data-id="${category.id}" title="View Books">
                                    <i class="fas fa-book pointer-events-none"></i>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    attachEventListeners() {
        ...
        // Categories Grid Action Buttons
        const contentArea = document.querySelector('.categories-content');
        if (contentArea) {
            contentArea.addEventListener('click', (e) => {
                ...
                switch (action) {
                    case 'view':
                        this.viewCategoryDetails(id);
                        break;
                    case 'view-books':
                        this.viewBooksInCategory(id);
                        break;
                    case 'edit':
